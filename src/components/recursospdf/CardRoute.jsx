    ...
    const cardData = [
      {
        ...
        imageSrc: 'https://www.traxco.es/blog/wp-content/uploads/2014/10/generador-eolico.jpg', 
      ...
      },
      {
        ...
        imageSrc: 'https://cdn.daa.net/images/placas-solares/instalacion-fotovoltaica-aislada.jpg', // Cambia la URL de la imagen
      ...
      },
      {
        ...
        imageSrc: 'https://repositorio.minedu.gob.pe/bitstream/handle/20.500.12799/6317/amigas2.png?sequence=3&isAllowed=y', // Cambia la URL de la imagen
        pdfUrl: 'http://localhost:5173/file3_pdf.pdf'
      },
      {
        title: '¿Por qué la energía solar es un recurso indispensable para el desarrollo de la vida?',
        ...
        imageSrc: 'https://todoagricola.es/energia/wp-content/uploads/2021/10/paneles-agricultura.jpg', // Cambia la URL de la imagen
        pdfUrl: 'http://localhost:5173/file4_pdf.pdf'
      },
      {
        title: '¿Cómo influye la energía solar en los seres vivos, el aire, el agua y el suelo?',
      ...
      },
      {
        ...
        imageSrc: 'https://www.wikihow.com/images_en/thumb/7/70/Use-an-Anemometer-Step-8.jpg/v4-460px-Use-an-Anemometer-Step-8.jpg.webp', // Cambia la URL de la imagen
